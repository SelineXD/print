...
if(isset($_GET['register'])) {
 ...
 $statement = $pdo->prepare("INSERT INTO users (vorname, nachname, adresse, ort, plz, email, passwort) VALUES (:vorname, :nachname, :adresse, :ort, :plz, :email, :passwort)");
 $result = $statement->execute(array('vorname' => $vorname, 'nachname' => $nachname, 'adresse' => $adresse, 'ort' => $ort, 'plz' => $plz, 'email' => $email, 'passwort' => $passwort_hash));
...
Adresse:<br>
<input type="text" size="40" maxlength="250" name="adresse"><br><br>

Ort:<br>
<input type="text" size="40" maxlength="250" name="ort"><br><br>

PLZ:<br>
<input type="text" size="5" maxlength="250" name="plz"><br><br>
